...
import com.tools20022.repository.codeset.ExternalUndertakingType1Code.InternalXmlAdapter;
...
public class ExternalUndertakingType1Code extends MMCode {

	final static private AtomicReference<MMCodeSet> mmObject_lazy = new AtomicReference<>();
	final static private LinkedHashMap<String, ExternalUndertakingType1Code> codesByName = new LinkedHashMap<>();

	protected ExternalUndertakingType1Code() {
	}
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				trace_lazy = () -> ExternalUndertakingTypeCode.mmObject();
				minLength = 1;
				maxLength = 4;
			}
		});
	...
	public static ExternalUndertakingType1Code valueOf(String codeName) {
		return codesByName.get(codeName);
	}

	public static ExternalUndertakingType1Code[] values() {
		ExternalUndertakingType1Code[] values = new ExternalUndertakingType1Code[codesByName.size()];
		return codesByName.values().toArray(values);
	}

	protected static class InternalXmlAdapter extends XmlAdapter<String, ExternalUndertakingType1Code> {
		@Override
		public ExternalUndertakingType1Code unmarshal(String codeName) {
			return valueOf(codeName);
		}

		@Override
		public String marshal(ExternalUndertakingType1Code codeObj) {
