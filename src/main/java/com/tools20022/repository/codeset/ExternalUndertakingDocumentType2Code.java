...
import com.tools20022.repository.codeset.ExternalUndertakingDocumentType2Code.InternalXmlAdapter;
...
public class ExternalUndertakingDocumentType2Code extends MMCode {

	final static private AtomicReference<MMCodeSet> mmObject_lazy = new AtomicReference<>();
	final static private LinkedHashMap<String, ExternalUndertakingDocumentType2Code> codesByName = new LinkedHashMap<>();

	protected ExternalUndertakingDocumentType2Code() {
	}
	...
	public static ExternalUndertakingDocumentType2Code valueOf(String codeName) {
		return codesByName.get(codeName);
	}

	public static ExternalUndertakingDocumentType2Code[] values() {
		ExternalUndertakingDocumentType2Code[] values = new ExternalUndertakingDocumentType2Code[codesByName.size()];
		return codesByName.values().toArray(values);
	}

	protected static class InternalXmlAdapter extends XmlAdapter<String, ExternalUndertakingDocumentType2Code> {
		@Override
		public ExternalUndertakingDocumentType2Code unmarshal(String codeName) {
			return valueOf(codeName);
		}

		@Override
		public String marshal(ExternalUndertakingDocumentType2Code codeObj) {
