...
import com.tools20022.repository.codeset.ExternalUndertakingDocumentType1Code.InternalXmlAdapter;
...
public class ExternalUndertakingDocumentType1Code extends MMCode {

	final static private AtomicReference<MMCodeSet> mmObject_lazy = new AtomicReference<>();
	final static private LinkedHashMap<String, ExternalUndertakingDocumentType1Code> codesByName = new LinkedHashMap<>();

	protected ExternalUndertakingDocumentType1Code() {
	}
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				name = "ExternalUndertakingDocumentType1Code";
	...
	public static ExternalUndertakingDocumentType1Code valueOf(String codeName) {
		return codesByName.get(codeName);
	}

	public static ExternalUndertakingDocumentType1Code[] values() {
		ExternalUndertakingDocumentType1Code[] values = new ExternalUndertakingDocumentType1Code[codesByName.size()];
		return codesByName.values().toArray(values);
	}

	protected static class InternalXmlAdapter extends XmlAdapter<String, ExternalUndertakingDocumentType1Code> {
		@Override
		public ExternalUndertakingDocumentType1Code unmarshal(String codeName) {
			return valueOf(codeName);
		}

		@Override
		public String marshal(ExternalUndertakingDocumentType1Code codeObj) {
