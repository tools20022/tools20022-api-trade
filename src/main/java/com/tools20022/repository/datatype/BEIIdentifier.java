...
import com.tools20022.repository.datatype.BEIIdentifier.InternalXmlAdapter;
...
public class BEIIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, BEIIdentifier> {
		@Override
		public BEIIdentifier unmarshal(String value) {
			return new BEIIdentifier(value);
		}

		@Override
		public String marshal(BEIIdentifier typedData) {
