...
public class PurchaseOrder extends Order {
	...
	public static final MMBusinessAttribute<PurchaseOrder, CurrencyAndAmount> mmTotalAmount = new MMBusinessAttribute<PurchaseOrder, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(ReportLine1.mmPurchaseOrderTotalNetAmount, LineItem14.mmOrderedLineItemsTotalAmount, LineItemDetails12.mmOrderedAmount);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<PurchaseOrder, GenericIdentification> mmIdentification = new MMBusinessAssociationEnd<PurchaseOrder, GenericIdentification>() {
		{
			derivation_lazy = () -> Arrays.asList(TransportedGoods1.mmPurchaseOrderReference, ReportLine1.mmPurchaseOrderReference, ReportLine7.mmPurchaseOrderReference, ReportLine5.mmPurchaseOrderReference,
					Baseline5.mmPurchaseOrderReference, LineItem15.mmPurchaseOrderReference);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PurchaseOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Identification";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ReportLine1.mmObject(), ReportLine7.mmObject(), ReportLine6.mmObject(), ReportLine5.mmObject());
			}
