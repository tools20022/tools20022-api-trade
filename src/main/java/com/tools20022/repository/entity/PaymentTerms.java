...
public class PaymentTerms {
	...
	public static final MMBusinessAttribute mmPaymentTime = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentPeriod1.mmCode, PaymentPeriod4.mmCode, PaymentPeriod3.mmCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentTerms.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PaymentTime";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(PaymentPeriod1.mmObject(), PaymentPeriod4.mmObject(), PaymentPeriod3.mmObject(), PaymentCodeOrOther2Choice.mmObject());
			}
