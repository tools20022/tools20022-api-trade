...
import com.tools20022.repository.msg.CommercialDataSet5;
...
public class Goods extends Product {
	...
	public static final MMBusinessAttribute<Goods, Max70Text> mmAnalysis = new MMBusinessAttribute<Goods, Max70Text>() {
		{
			derivation_lazy = () -> Arrays.asList(CertifiedCharacteristics2Choice.mmAnalysis);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Goods.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Analysis";
	...
	public static final MMBusinessAttribute<Goods, YesNoIndicator> mmHealthCheck = new MMBusinessAttribute<Goods, YesNoIndicator>() {
		{
			derivation_lazy = () -> Arrays.asList(CertifiedCharacteristics2Choice.mmHealthIndication);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Goods.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "HealthCheck";
	...
	public static final MMBusinessAttribute<Goods, YesNoIndicator> mmPhytosanitaryInspection = new MMBusinessAttribute<Goods, YesNoIndicator>() {
		{
			derivation_lazy = () -> Arrays.asList(CertifiedCharacteristics2Choice.mmPhytosanitaryIndication);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Goods.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Baseline5.mmGoods, CommercialDataSet5.mmGoods);
