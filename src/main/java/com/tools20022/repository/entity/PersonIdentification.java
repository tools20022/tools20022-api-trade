...
public class PersonIdentification extends PartyIdentificationInformation {
	...
	public static final MMBusinessAttribute mmSocialSecurityNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmSocialSecurityNumber);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmPerson = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmDateAndPlaceOfBirth, PersonIdentification5.mmDateAndPlaceOfBirth);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Person";
	...
	public static final MMBusinessAttribute mmDriversLicenseNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmDriversLicenseNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmAlienRegistrationNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmAlienRegistrationNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPassportNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmPassportNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PassportNumber";
	...
	public static final MMBusinessAttribute mmIdentityCardNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmIdentityCardNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmEmployerIdentificationNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification3.mmEmployerIdentificationNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Party2Choice.mmPrivateIdentification, Party6Choice.mmPrivateIdentification, Party11Choice.mmPrivateIdentification, Party8Choice.mmPrivateIdentification,
						Party10Choice.mmPrivateIdentification, TaxOrganisationIdentification1.mmContactDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(PersonIdentification3.mmObject(), PersonIdentificationSchemeName1Choice.mmObject(), GenericPersonIdentification1.mmObject(), PersonIdentification5.mmObject(),
						ContactDetails2.mmObject());
			}
