		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SingleTransport3.mmTransportByRail, SingleTransport7.mmTransportByRail, SingleTransport8.mmTransportByRail);
				...
				derivationComponent_lazy = () -> Arrays.asList(TransportByRail2.mmObject(), TransportByRail4.mmObject(), TransportByRail5.mmObject());
			}
