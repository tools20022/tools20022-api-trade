		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(FinancingAllowedSummary1.mmFinancingDateDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(FinancingDateDetails1.mmObject());
			}
