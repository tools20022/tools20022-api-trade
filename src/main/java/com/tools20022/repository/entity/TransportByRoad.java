		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SingleTransport3.mmTransportByRoad, SingleTransport7.mmTransportByRoad, SingleTransport8.mmTransportByRoad);
				superType_lazy = () -> Transport.mmObject();
				derivationComponent_lazy = () -> Arrays.asList(TransportByRoad2.mmObject(), TransportByRoad4.mmObject(), TransportByRoad5.mmObject());
			}
