...
public class OrganisationIdentification extends PartyIdentificationInformation {
	...
	public static final MMBusinessAttribute mmBICFI = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmBICFI, OrganisationIdentification2.mmBIC, BICIdentification1.mmBIC, FinancialInstitutionIdentification7.mmBIC, OrganisationIdentification6.mmBIC,
					FinancialInstitutionIdentification6.mmBIC, FinancialInstitutionIdentification4Choice.mmBIC, RequiredSubmission2.mmSubmitter, ContactIdentification3.mmBIC, PartyIdentification29Choice.mmBIC,
					Baseline5.mmBuyerSideSubmittingBank, Baseline5.mmSellerSideSubmittingBank);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmAnyBIC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PartyIdentification2Choice.mmBICOrBEI, OrganisationIdentification4.mmBICOrBEI, OrganisationIdentification8.mmAnyBIC, OrganisationIdentification7.mmAnyBIC);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "AnyBIC";
	...
	public static final MMBusinessAssociationEnd mmClearingSystemMemberIdentificationType = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmClearingSystemMemberIdentification, FinancialInstitutionIdentification7.mmClearingSystemMemberIdentification,
					FinancialInstitutionIdentification6.mmClearingSystemMemberIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmBICNonFI = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OrganisationIdentification2.mmIBEI, OrganisationIdentification2.mmBEI, PartyIdentification25.mmBEI);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BICNonFI";
	...
	public static final MMBusinessAttribute mmEANGLN = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OrganisationIdentification2.mmEANGLN);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "EANGLN";
	...
	public static final MMBusinessAttribute mmCHIPSUniversalIdentifier = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OrganisationIdentification2.mmCHIPSUniversalIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmDUNS = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OrganisationIdentification2.mmDUNS);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "DUNS";
	...
	public static final MMBusinessAttribute mmBankPartyIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OrganisationIdentification2.mmBankPartyIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.OrganisationIdentification.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmOther, Party2Choice.mmOrganisationIdentification, Party6Choice.mmOrganisationIdentification, Party11Choice.mmOrganisationIdentification,
						FinancialInstitutionIdentification7.mmOther, Party8Choice.mmOrganisationIdentification, Party10Choice.mmOrganisationIdentification, Party9Choice.mmOrganisationIdentification,
						Party9Choice.mmFinancialInstitutionIdentification, FinancialInstitutionIdentification4Choice.mmNameAndAddress);
				...
				derivationComponent_lazy = () -> Arrays.asList(GenericFinancialIdentification1.mmObject(), FinancialInstitutionIdentification8.mmObject(), BranchData2.mmObject(), OrganisationIdentification2.mmObject(),
						OrganisationIdentificationSchemeName1Choice.mmObject(), GenericOrganisationIdentification1.mmObject(), OrganisationIdentification4.mmObject(), OrganisationIdentification8.mmObject(),
						FinancialInstitutionIdentification7.mmObject(), OrganisationIdentification7.mmObject(), OrganisationIdentification6.mmObject(), FinancialInstitutionIdentification6.mmObject(),
						FinancialInstitutionIdentification4Choice.mmObject(), TaxOrganisationIdentification1.mmObject());
			}
