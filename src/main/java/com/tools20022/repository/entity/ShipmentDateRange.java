...
public class ShipmentDateRange {
	...
	public static final MMBusinessAttribute mmLatestShipmentDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ShipmentDateRange1.mmLatestShipmentDate, ShipmentDateRange2.mmLatestShipmentDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmShipmentDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ShipmentDate1Choice.mmProposedShipmentDate, ShipmentDate1Choice.mmActualShipmentDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ShipmentDateRange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ShipmentDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ShipmentDateRange1.mmObject(), ShipmentDateRange2.mmObject(), ShipmentSchedule2Choice.mmObject());
			}
