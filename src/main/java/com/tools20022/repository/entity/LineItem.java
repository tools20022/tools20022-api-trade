...
public class LineItem {
	...
	public static final MMBusinessAssociationEnd<LineItem, Adjustment> mmFinancialAdjustment = new MMBusinessAssociationEnd<LineItem, Adjustment>() {
		{
			derivation_lazy = () -> Arrays.asList(InvoiceTotals1.mmAdjustment);
			isDerived = false;
	...
	public static final MMBusinessAttribute<LineItem, Max35Text> mmIdentification = new MMBusinessAttribute<LineItem, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(RequiredSubmission4.mmLineItemIdentification, LineItemAndPOIdentification1.mmLineItemIdentification, LineItemDetails13.mmLineItemIdentification, LineItemDetails12.mmLineItemIdentification,
					LineItemDetails14.mmLineItemIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.LineItem.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Identification";
	...
	public static final MMBusinessAttribute<LineItem, CurrencyAndAmount> mmNetAmount = new MMBusinessAttribute<LineItem, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(ReportLine7.mmNetAmount, ReportLine6.mmNetAmount, ReportLine5.mmNetAmount, LineItemDetails13.mmTotalAmount, LineItemDetails14.mmTotalAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.LineItem.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "NetAmount";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(LineItemAndPOIdentification1.mmObject(), LineItemDetails13.mmObject(), LineItemDetails12.mmObject(), LineItemDetails14.mmObject());
			}
