...
public class Account {
	...
	public static final MMBusinessAttribute mmBaseCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CashAccount7.mmCurrency, CashAccount16.mmCurrency, CashAccount24.mmCurrency, CashAccount28.mmCurrency, CashAccount27.mmCurrency);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmIdentification = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CashAccount7.mmIdentification, CashAccount16.mmIdentification, CashAccount24.mmIdentification, CashAccount28.mmIdentification, CashAccount27.mmIdentification,
					FinancialItemParameters1.mmDebitAccount, FinancialItemParameters1.mmCreditAccount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Account.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Identification";
