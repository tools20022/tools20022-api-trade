...
public class CommercialTrade extends Trade {
	...
	public static final MMBusinessAssociationEnd mmPaymentObligation = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(Baseline5.mmPaymentTerms, Baseline5.mmPaymentObligation, CommercialDataSet5.mmPaymentTerms);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CommercialTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmTotalAcceptedAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(LineItem14.mmAcceptedLineItemsTotalAmount, TradeSettlement2.mmTaxTotalAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CommercialTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Baseline5.mmObject(), CommercialDataSet5.mmObject(), LineItem13.mmObject(), LineItem15.mmObject(), TradeSettlement2.mmObject());
			}
