		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(GenericIdentification1.mmIssuer, GenericIdentification13.mmIssuer, GenericIdentification20.mmIssuer, GenericIdentification3.mmIssuer, GenericFinancialIdentification1.mmIssuer,
						GenericAccountIdentification1.mmIssuer, PersonIdentification3.mmIssuer, GenericOrganisationIdentification1.mmIssuer, GenericPersonIdentification1.mmIssuer);
