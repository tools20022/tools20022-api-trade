...
public class Price {
	...
	public static final MMBusinessAttribute<Price, CurrencyAndAmount> mmAmount = new MMBusinessAttribute<Price, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(UnitPrice18.mmAmount);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<Price, List<Adjustment>> mmPriceAdjustment = new MMBusinessAssociationEnd<Price, List<Adjustment>>() {
		{
			derivation_lazy = () -> Arrays.asList(ReportLine7.mmAdjustment, ReportLine6.mmAdjustment, ReportLine5.mmAdjustment, LineItemDetails13.mmAdjustment, LineItem13.mmAdjustment, LineItem15.mmAdjustment,
					LineItemDetails14.mmAdjustment);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Price.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Price, UnitOfMeasureCode> mmUnitOfMeasure = new MMBusinessAttribute<Price, UnitOfMeasureCode>() {
		{
			derivation_lazy = () -> Arrays.asList(UnitPrice18.mmUnitPrice);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Price.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "UnitOfMeasure";
	...
	public static final MMBusinessAssociationEnd<Price, Tolerance> mmPriceTolerance = new MMBusinessAssociationEnd<Price, Tolerance>() {
		{
			derivation_lazy = () -> Arrays.asList(LineItemDetails13.mmPriceTolerance, LineItemDetails12.mmPriceTolerance);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Price.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PriceTolerance";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(UnitPrice18.mmObject());
			}
