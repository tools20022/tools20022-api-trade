...
public class Country {
	...
	public static final MMBusinessAttribute mmCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress1.mmCountry, PostalAddress6.mmCountry, DateAndPlaceOfBirth.mmCountryOfBirth, PartyIdentification8.mmCountryOfResidence, PartyIdentification32.mmCountryOfResidence,
					PartyIdentification43.mmCountryOfResidence, PartyIdentification41.mmCountryOfResidence, PartyIdentification42.mmCountryOfResidence, Location1.mmCountry, PostalAddress12.mmCountry, PlaceOfPresentation1.mmCountry,
					PartyIdentification45.mmCountryOfResidence, PostalAddress2.mmCountry, PostalAddress5.mmCountry, PartyIdentification27.mmCountry, TransportByRail4.mmRailCarrierCountry, TransportByRail4.mmCarrierAgentCountry,
					TransportByAir4.mmAirCarrierCountry, TransportByAir4.mmCarrierAgentCountry, TransportByRoad4.mmRoadCarrierCountry, TransportByRoad4.mmCarrierAgentCountry, TransportBySea5.mmSeaCarrierCountry,
					...
					TransportByRail5.mmRailCarrierCountry, TransportByRail5.mmCarrierAgentCountry, TransportByRoad5.mmRoadCarrierCountry, TransportByRoad5.mmCarrierAgentCountry, LineItemDetails13.mmProductOrigin,
					LineItemDetails14.mmProductOrigin);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Country.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(ReportSpecification4.mmCorrespondentCountry);
