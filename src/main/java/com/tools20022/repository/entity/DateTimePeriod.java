...
public class DateTimePeriod {
	...
	public static final MMBusinessAttribute<DateTimePeriod, ISODateTime> mmFromDateTime = new MMBusinessAttribute<DateTimePeriod, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(DatePeriodDetails.mmFromDate, Period2.mmFromDate, DateTimePeriodDetails1.mmFromDateTime, AmountAndPeriod1.mmStartDate, PercentageAndPeriod1.mmStartDate, PercentageAndPeriod1.mmEndDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute<DateTimePeriod, ISODateTime> mmToDateTime = new MMBusinessAttribute<DateTimePeriod, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(DatePeriodDetails.mmToDate, Period2.mmToDate, DateTimePeriodDetails1.mmToDateTime, AmountAndPeriod1.mmEndDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.DateTimePeriod.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ToDateTime";
	...
	public static final MMBusinessAttribute<DateTimePeriod, Number> mmNumberOfDays = new MMBusinessAttribute<DateTimePeriod, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentPeriod1.mmNumberOfDays, PaymentPeriod4.mmNumberOfDays, PaymentPeriod3.mmNumberOfDays);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.DateTimePeriod.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "NumberOfDays";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(DatePeriodDetails.mmObject(), Period2.mmObject(), DateTimePeriodDetails1.mmObject());
			}
