...
public class CashAccount extends Account {
	...
	public static final MMBusinessAttribute<CashAccount, CashAccountTypeCode> mmCashAccountType = new MMBusinessAttribute<CashAccount, CashAccountTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(CashAccountType2.mmCode, CashAccountType2.mmProprietary, CashAccountType2Choice.mmCode, CashAccountType2Choice.mmProprietary, CashAccount7.mmType, CashAccount16.mmType,
					CashAccount24.mmType, CashAccount27.mmType);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CashAccountType2.mmObject(), CashAccountType2Choice.mmObject(), CashAccount7.mmObject(), CashAccount16.mmObject(), CashAccount24.mmObject(), CashAccount28.mmObject(),
						CashAccount27.mmObject());
			}
