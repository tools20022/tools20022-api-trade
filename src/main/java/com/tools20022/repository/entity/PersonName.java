...
public class PersonName extends PartyName {
	...
	public static final MMBusinessAttribute mmNamePrefix = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ContactDetails2.mmNamePrefix, ContactIdentification1.mmNamePrefix, Contacts3.mmNamePrefix, ContactIdentification3.mmNamePrefix);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonName.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "NamePrefix";
	...
	public static final MMBusinessAttribute mmGivenName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ContactIdentification1.mmGivenName, ContactIdentification3.mmGivenName);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PersonName.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "GivenName";
