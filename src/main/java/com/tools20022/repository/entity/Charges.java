...
public class Charges extends Adjustment {
	...
	public static final MMBusinessAttribute mmChargeType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Charges5.mmType, ChargesDetails3.mmType, ChargesType1Choice.mmType, ChargesType1Choice.mmOtherChargesType, ChargesDetails4.mmChargesType);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PaymentObligation2.mmCharges, Charge24.mmCharges, Charge25.mmCharges);
				...
				derivationComponent_lazy = () -> Arrays.asList(Charges5.mmObject(), Charge24.mmObject(), ChargesDetails3.mmObject(), ChargesType1Choice.mmObject(), Charge25.mmObject(), ChargesDetails4.mmObject());
			}
