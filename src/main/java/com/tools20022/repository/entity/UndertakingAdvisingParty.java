		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Amendment2.mmFirstAdvisingPartyAdditionalInformation, Amendment2.mmSecondAdvisingPartyAdditionalInformation, Undertaking1.mmSecondAdvisingParty,
