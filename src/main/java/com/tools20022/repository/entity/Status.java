...
public class Status {
	...
	public static final MMBusinessAttribute mmStatusDateTime = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(TransactionStatus5.mmChangeDateTime);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Status.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "StatusDateTime";
	...
	public static final MMBusinessAttribute mmStatusDescription = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(UndertakingTermination3.mmAdditionalInformation, CancellationStatusInformation1.mmAdditionalStatusReasonInformation, GenericValidationRuleIdentification1.mmDescription);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Status.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(GenericValidationRuleIdentification1.mmIdentification);
				...
				derivationComponent_lazy = () -> Arrays.asList(GenericValidationRuleIdentification1.mmObject());
			}
