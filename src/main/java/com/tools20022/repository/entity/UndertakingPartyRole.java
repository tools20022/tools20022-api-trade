 ...
 * subType} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingIssuer
 * UndertakingIssuer}</li>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingDeliveryToParty
 * UndertakingDeliveryToParty}</li>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingAdvisingParty
 * UndertakingAdvisingParty}</li>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingBeneficiary
 ...
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingApplicant
 * UndertakingApplicant}</li>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingConfirmer
 * UndertakingConfirmer}</li>
 * <li>{@linkplain com.tools20022.repository.entity.UndertakingPresenter
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				subType_lazy = () -> Arrays.asList(UndertakingIssuer.mmObject(), UndertakingDeliveryToParty.mmObject(), UndertakingAdvisingParty.mmObject(), UndertakingBeneficiary.mmObject(), UndertakingUltimateObligor.mmObject(),
						UndertakingApplicant.mmObject(), UndertakingConfirmer.mmObject(), UndertakingPresenter.mmObject(), UndertakingPlaceOfPresentation.mmObject());
