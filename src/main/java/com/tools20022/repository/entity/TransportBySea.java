		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SingleTransport3.mmTransportBySea, SingleTransport7.mmTransportBySea, SingleTransport8.mmTransportBySea);
				...
				derivationComponent_lazy = () -> Arrays.asList(TransportBySea4.mmObject(), TransportBySea5.mmObject(), ShipmentDate1Choice.mmObject(), TransportBySea6.mmObject());
			}
