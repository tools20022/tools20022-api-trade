...
public class Agreement {
	...
	public static final MMBusinessAssociationEnd<Agreement, Document> mmDocument = new MMBusinessAssociationEnd<Agreement, Document>() {
		{
			derivation_lazy = () -> Arrays.asList(InvoiceRequestInformation1.mmInvoiceGeneralInformation, FinancingAgreementItem1.mmRelatedGuaranteeLetter, FinancingAgreementItem1.mmAssociatedDocument);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Agreement.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Document";
