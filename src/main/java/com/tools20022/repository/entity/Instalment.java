		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(InvoiceRequestInformation1.mmInstalmentInformation, InvoiceFinancingDetails1.mmInstalmentFinancingInformation, FinancingItemList1.mmFinancingInstalment,
						FinancialItem1.mmInstalmentInformation);
				...
				derivationComponent_lazy = () -> Arrays.asList(Instalment1.mmObject(), Instalment2.mmObject());
			}
