...
public class ProductQuantity {
	...
	public static final MMBusinessAttribute mmUnitOfMeasure = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Quantity10.mmUnitOfMeasure, UnitOfMeasure3Choice.mmUnitOfMeasureCode, UnitOfMeasure3Choice.mmOtherUnitOfMeasure, Quantity9.mmUnitOfMeasure);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmValue = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Quantity10.mmValue, Quantity9.mmValue);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ProductQuantity.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Value";
	...
	public static final MMBusinessAttribute mmFactor = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Quantity9.mmFactor, UnitPrice18.mmFactor);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ProductQuantity.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Factor";
	...
	public static final MMBusinessAssociationEnd mmQuantityTolerance = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(LineItemDetails13.mmQuantityTolerance, LineItemDetails12.mmQuantityTolerance);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ProductQuantity.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
