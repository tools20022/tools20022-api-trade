...
public class BaselineStatus extends Status {
	...
	public static final MMBusinessAttribute<BaselineStatus, BaselineStatusCode> mmStatus = new MMBusinessAttribute<BaselineStatus, BaselineStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(TransactionStatus4.mmStatus, TransactionStatus3.mmStatus, TransactionStatus5.mmStatus, StatusReportItems2.mmStatus);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(TransactionStatus4.mmObject(), TransactionStatus3.mmObject(), TransactionStatus5.mmObject());
			}
