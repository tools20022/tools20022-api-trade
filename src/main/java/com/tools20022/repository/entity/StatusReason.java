...
public class StatusReason {
	...
	public static final MMBusinessAttribute<StatusReason, Max35Text> mmReason = new MMBusinessAttribute<StatusReason, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(StatusReason6Choice.mmCode, StatusReason6Choice.mmProprietary, Discrepancy1.mmNarrative, FinancingResult1.mmAdditionalStatusReasonInformation, Reason2.mmDescription);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.StatusReason.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Reason";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(RejectionReason1Choice.mmGlobalRejectionReason);
				...
				derivationComponent_lazy = () -> Arrays.asList(StatusReason6Choice.mmObject(), Reason2.mmObject(), RejectionReason1Choice.mmObject());
			}
