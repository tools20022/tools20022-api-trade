...
import com.tools20022.repository.msg.CertificateDataSet2;
import com.tools20022.repository.msg.OtherCertificateDataSet2;
import com.tools20022.repository.msg.RequiredSubmission4;
import com.tools20022.repository.msg.RequiredSubmission6;
...
public class TradeCertificate extends Document {
	...
	public static final MMBusinessAttribute mmCertificateType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RequiredSubmission4.mmCertificateType, CertificateDataSet2.mmCertificateType, OtherCertificateDataSet2.mmCertificateType, RequiredSubmission6.mmCertificateType);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmInspectionDate = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CertificateDataSet2.mmInspectionDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TradeCertificate.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "InspectionDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(RequiredSubmission4.mmObject(), CertificateDataSet2.mmObject(), OtherCertificateDataSet2.mmObject(), RequiredSubmission6.mmObject());
			}
