		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PartyAndSignature2.mmSignature, Document9.mmDigitalSignature, BusinessLetter1.mmDigitalSignature, QualifiedPartyAndXMLSignature1.mmSignature);
