	...
	public static final MMBusinessAssociationEnd<Organisation, List<OrganisationIdentification>> mmOrganisationIdentification = new MMBusinessAssociationEnd<Organisation, List<OrganisationIdentification>>() {
		{
			derivation_lazy = () -> Arrays.asList(BranchAndFinancialInstitutionIdentification5.mmFinancialInstitutionIdentification, BranchAndFinancialInstitutionIdentification5.mmBranchIdentification,
					BranchAndFinancialInstitutionIdentification4.mmFinancialInstitutionIdentification, BranchAndFinancialInstitutionIdentification4.mmBranchIdentification, OriginalRequestInformation1.mmIntermediaryAgent,
					OriginalRequestInformation1.mmFirstAgent, CancellationRequestInformation1.mmIntermediaryAgent, PaymentMeans1.mmPayeeFinancialInstitution, PaymentMeans1.mmPayerFinancialInstitution, SettlementTerms3.mmCreditorAgent,
					OrganisationIdentification28.mmIdentification);
			isDerived = false;
			elementContext_lazy = () -> Organisation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(TradeParty1.mmLegalOrganisation, OrganisationIdentification28.mmName, OrganisationIdentification28.mmPostalAddress);
				...
				derivationComponent_lazy = () -> Arrays.asList(BranchAndFinancialInstitutionIdentification5.mmObject(), BranchAndFinancialInstitutionIdentification4.mmObject(), LegalOrganisation1.mmObject(),
						OrganisationIdentification28.mmObject());
			}
