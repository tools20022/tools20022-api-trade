...
public class Adjustment {
	...
	public static final MMBusinessAttribute<Adjustment, CurrencyAndAmount> mmAmount = new MMBusinessAttribute<Adjustment, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(Adjustment5.mmAmount, Charges5.mmAmount, Adjustment6.mmAmount, Adjustment7.mmAmountOrPercentage, ChargesDetails4.mmAmount, PaymentTerms6.mmPenaltyAmount, FinancialItem1.mmDueAmount);
			isDerived = false;
	...
	public static final MMBusinessAttribute<Adjustment, PercentageRate> mmChargeRate = new MMBusinessAttribute<Adjustment, PercentageRate>() {
		{
			derivation_lazy = () -> Arrays.asList(Charges5.mmPercentage, PaymentTerms6.mmDiscountPercentRate, PaymentTerms6.mmPenaltyPercentRate, EarlyPayment1.mmDiscountPercent);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Adjustment.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ChargeRate";
	...
	public static final MMBusinessAttribute<Adjustment, AdjustmentDirectionCode> mmDirection = new MMBusinessAttribute<Adjustment, AdjustmentDirectionCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Adjustment5.mmDirection, Adjustment6.mmDirection, Adjustment7.mmDirection);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Adjustment.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Direction";
	...
	public static final MMBusinessAttribute<Adjustment, AdjustmentTypeCode> mmType = new MMBusinessAttribute<Adjustment, AdjustmentTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Adjustment6.mmType, Adjustment7.mmType, AdjustmentType1Choice.mmType, AdjustmentType1Choice.mmOtherAdjustmentType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Adjustment.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Adjustment5.mmObject(), Adjustment6.mmObject(), Adjustment7.mmObject(), AdjustmentType1Choice.mmObject());
			}
