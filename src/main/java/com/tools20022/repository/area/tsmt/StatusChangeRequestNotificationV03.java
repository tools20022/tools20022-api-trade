...
/**
 * <b>Scope</b><br>
 * The StatusChangeRequestNotification message is sent by the matching
 * application to the party requested to accept or reject the request of a
 * change in the status of a transaction.<br>
 * This message is used to notify the request of a change in the status of a
 * transaction.<br>
 * <b>Usage</b><br>
 * The StatusChangeRequestNotification message can be sent by the matching
...
@XmlType(name = "StatusChangeRequestNotificationV03", propOrder = {"notificationIdentification", "transactionIdentification", "establishedBaselineIdentification", "transactionStatus", "userTransactionReference", "proposedStatusChange",
		"requestReason", "initiator", "requestForAction"})
public class StatusChangeRequestNotificationV03 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, MessageIdentification1> mmNotificationIdentification = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, MessageIdentification1>() {
		{
			xmlTag = "NtfctnId";
		...
		@Override
		public MessageIdentification1 getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getNotificationIdentification();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, SimpleIdentificationInformation> mmTransactionIdentification = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, SimpleIdentificationInformation>() {
		{
			xmlTag = "TxId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public SimpleIdentificationInformation getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getTransactionIdentification();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, SimpleIdentificationInformation value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<DocumentIdentification3>> mmEstablishedBaselineIdentification = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<DocumentIdentification3>>() {
		{
		...
		@Override
		public Optional<DocumentIdentification3> getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getEstablishedBaselineIdentification();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, Optional<DocumentIdentification3> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, TransactionStatus4> mmTransactionStatus = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, TransactionStatus4>() {
		{
			xmlTag = "TxSts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public TransactionStatus4 getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getTransactionStatus();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, TransactionStatus4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, List<DocumentIdentification5>> mmUserTransactionReference = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, List<DocumentIdentification5>>() {
		{
			xmlTag = "UsrTxRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<DocumentIdentification5> getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getUserTransactionReference();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, List<DocumentIdentification5> value) {
			obj.setUserTransactionReference(value);
		}
	};
	@XmlElement(name = "PropsdStsChng", required = true)
	protected TransactionStatus3 proposedStatusChange;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageConstruct#getXmlTag
	 * xmlTag} = "PropsdStsChng"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getRegistrationStatus
	 * registrationStatus} =
	 * com.tools20022.metamodel.MMRegistrationStatus.PROVISIONALLY_REGISTERED</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getName
	 * name} = "ProposedStatusChange"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, TransactionStatus3> mmProposedStatusChange = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, TransactionStatus3>() {
		{
		...
		@Override
		public TransactionStatus3 getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getProposedStatusChange();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, TransactionStatus3 value) {
			obj.setProposedStatusChange(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<Reason2>> mmRequestReason = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<Reason2>>() {
		{
			xmlTag = "ReqRsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "RequestReason";
		...
		@Override
		public Optional<Reason2> getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getRequestReason();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, Optional<Reason2> value) {
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "Party that has requested the status change."</li>
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, BICIdentification1> mmInitiator = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, BICIdentification1>() {
		{
			xmlTag = "Initr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Initiator";
		...
		@Override
		public BICIdentification1 getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getInitiator();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, BICIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<PendingActivity2>> mmRequestForAction = new MMMessageBuildingBlock<StatusChangeRequestNotificationV03, Optional<PendingActivity2>>() {
		{
			xmlTag = "ReqForActn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<PendingActivity2> getValue(StatusChangeRequestNotificationV03 obj) {
			return obj.getRequestForAction();
		}

		@Override
		public void setValue(StatusChangeRequestNotificationV03 obj, Optional<PendingActivity2> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			...
			public Class<?> getInstanceClass() {
				return StatusChangeRequestNotificationV03.class;
			}
		});
	...
	public StatusChangeRequestNotificationV03 setNotificationIdentification(MessageIdentification1 notificationIdentification) {
	...
	public StatusChangeRequestNotificationV03 setTransactionIdentification(SimpleIdentificationInformation transactionIdentification) {
	...
	public StatusChangeRequestNotificationV03 setEstablishedBaselineIdentification(DocumentIdentification3 establishedBaselineIdentification) {
	...
	public StatusChangeRequestNotificationV03 setTransactionStatus(TransactionStatus4 transactionStatus) {
	...
	public StatusChangeRequestNotificationV03 setUserTransactionReference(List<DocumentIdentification5> userTransactionReference) {
	...
	public StatusChangeRequestNotificationV03 setProposedStatusChange(TransactionStatus3 proposedStatusChange) {
		this.proposedStatusChange = Objects.requireNonNull(proposedStatusChange);
		return this;
	}
	...
	public StatusChangeRequestNotificationV03 setRequestReason(Reason2 requestReason) {
	...
	public StatusChangeRequestNotificationV03 setInitiator(BICIdentification1 initiator) {
	...
	public StatusChangeRequestNotificationV03 setRequestForAction(PendingActivity2 requestForAction) {
	...
	static public class Document {
		...
		public StatusChangeRequestNotificationV03 messageBody;
	}
}