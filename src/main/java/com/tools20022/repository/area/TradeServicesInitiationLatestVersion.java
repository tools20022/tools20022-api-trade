		...
		mmObject_lazy.compareAndSet(null, new MMBusinessArea() {
			{
				...
				messageDefinition_lazy = () -> Arrays.asList(UndertakingApplicationV01.mmObject(), InvoiceFinancingRequestV01.mmObject(), InvoiceFinancingRequestStatusV01.mmObject(), InvoiceFinancingCancellationRequestV01.mmObject(),
						InvoiceAssignmentRequestV01.mmObject(), PartyRegistrationAndGuaranteeAcknowledgementV01.mmObject(), PartyRegistrationAndGuaranteeStatusV01.mmObject(), PartyRegistrationAndGuaranteeNotificationV01.mmObject(),
						InvoiceAssignmentNotificationV01.mmObject(), InvoiceAssignmentAcknowledgementV01.mmObject(), InvoiceAssignmentStatusV01.mmObject(), PartyRegistrationAndGuaranteeRequestV01.mmObject());
			}
		});
