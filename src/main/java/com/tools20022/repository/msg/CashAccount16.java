...
public class CashAccount16 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.CashAccount16 CashAccount16}</li>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashAccount16.mmIdentification, CashAccount16.mmType, CashAccount16.mmCurrency, CashAccount16.mmName);
